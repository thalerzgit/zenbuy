  ...
  return shell(
    ...
    `
      ...
      <ul>
        ...
        <li><strong>The network your request came from</strong> — a coarsened form of your IP address (the surrounding /24 or /48 block, not the exact address). On its own it is never treated as an identity, because thousands of people share one mobile carrier address. A coarse network block is one of the signals used to stop a fresh private window from minting a new allowance.</li>
      </ul>
